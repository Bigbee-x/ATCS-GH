...
# Road arm lengths
const BOUNDARY_ARM      := 55.0   # Boundary road arms (lengthened for breathing room)
const CROSS_ARM         := 55.0   # Cross-street arms (lengthened for breathing room)
...
func _build_ground() -> void:
	...
	ground.size = Vector3(130.0, 0.02, 190.0)
